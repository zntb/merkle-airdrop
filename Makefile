...
install :; forge install openzeppelin/openzeppelin-contracts --no-commit && forge install dmfxyz/murky --no-commit && forge install Cyfrin/foundry-devops --no-commit && forge install foundry-rs/forge-std --no-commit
